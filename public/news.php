...
<div class="news_entry_one">
    <div class="news_image">
        <a href="#"><img src="assets/images/news_container/<?php echo $rec['image_name'] ?>" alt="advertisement for free software development training"></a>
    ...
    <div class="news_info">
        ...
        <div class="news_author"> <!-- maybe for jscript, this would change -->
            <img class="author_image" src="assets/images/news_container/netmatters_logo_small.png" alt="image of Tessa Woodrow">
            <div class="posted_by">
